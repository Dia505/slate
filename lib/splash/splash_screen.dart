        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text("SLATE", style: GoogleFonts.jura(textStyle: TextStyle(color: Colors.white, fontSize: 64))),
            ),

            Padding(
              padding: const EdgeInsets.only(left: 90.0, bottom: 20.0),
              child: Text("Explore", style: GoogleFonts.jura(textStyle: TextStyle(color: Colors.white, fontSize: 32))),
            ),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 90.0, bottom: 20.0, top: 20.0),
              child: Text("Share", style: GoogleFonts.jura(textStyle: TextStyle(color: Colors.white, fontSize: 32))),
            ),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 90.0, bottom: 60.0, top: 20.0),
              child: Text("Inspire", style: GoogleFonts.jura(textStyle: TextStyle(color: Colors.white, fontSize: 32))),
            ),
            ...
            Padding(
              ...
              child: ElevatedButton(onPressed: () {
                Navigator.pushReplacementNamed(context, NavigationScreen.routeName);},
                  ...
                  child: Text("Get Started", style: GoogleFonts.jura(textStyle: TextStyle(fontSize: 20))),
